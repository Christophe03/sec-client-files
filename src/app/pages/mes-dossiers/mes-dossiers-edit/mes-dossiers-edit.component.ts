...
@Component({
  selector: 'app-mes-dossiers-edit',
  // standalone: true,
  // imports: [],
  templateUrl: './mes-dossiers-edit.component.html',
  styleUrl: './mes-dossiers-edit.component.scss',
})
export class MesDossiersEditComponent {
